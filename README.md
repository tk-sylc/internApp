...
- 利用開始日、利用終了日、利用場所を入力項目として残し、返却では利用終了日だけを表示する
- 対象者氏名・利用者氏名は重複させず「申請者氏名」に統一する
- PCはCPU、RAM、OSとバージョン、各種ソフトウェア、ブラウザ、性能、ウイルス対策確認を記録する
- スマートフォンはOSとバージョン、容量、性能、電話番号、キャリア、セキュリティソフトを記録する
...
- 申請者氏名、機種名、利用日、利用場所、機器性能などを分かる範囲で入力
- PC・スマートフォンの性能、OS、セキュリティソフトとウイルス対策導入確認
- LAN機器の暗号方式と入手方法
